...
pub struct ScalarHistory {
    pub last_fn: Option<Function<f64, f64>>,
    pub ctx: Context<f64, f64>,
    pub inputs: Vec<Scalar>,
}

impl ScalarHistory {
    pub fn last_fn(mut self, f: Function<f64, f64>) -> Self {
        self.last_fn = Some(f);
        self
    }
    ...
    pub fn context(mut self, c: Context<f64, f64>) -> Self {
        self.ctx = c;
        self
    }
